        ...
        function getBlockTemplate(subsidy) {
            ...
            function (result) {
                    if (result.error) {
                        ...
                        result.response.miner = (options.coin.disableminersubsidy) ? "" : subsidy.miner;
                        result.response.founders = (options.coin.disableminersubsidy) ? "" : (subsidy.founders || subsidy.community || (subsidy['founders-chris'] + subsidy['founders-jimmy'] + subsidy['founders-scott'] + subsidy['founders-shelby'] + subsidy['founders-loki'] ));
                        ...
                        result.response.securenodes = (options.coin.disableminersubsidy) ? "" : (subsidy.securenodes || 0);
                        result.response.supernodes = (options.coin.disableminersubsidy) ? "" : (subsidy.supernodes || 0);

                        // SafeCash
                        result.response.infrastructure = (options.coin.disableminersubsidy) ? "" : (subsidy.infrastructure || 0);
                        result.response.giveaways = (options.coin.disableminersubsidy) ? "" : (subsidy.giveaways || 0);
                        result.response.chris = (options.coin.disableminersubsidy) ? "" : (subsidy['founders-chris'] || 0);
                        result.response.jimmy = (options.coin.disableminersubsidy) ? "" : (subsidy['founders-jimmy'] || 0);
                        result.response.scott = (options.coin.disableminersubsidy) ? "" : (subsidy['founders-scott'] || 0);
                        result.response.shelby = (options.coin.disableminersubsidy) ? "" : (subsidy['founders-shelby'] || 0);
                        result.response.loki = (options.coin.disableminersubsidy) ? "" : (subsidy['founders-loki'] || 0);
