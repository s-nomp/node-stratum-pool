...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.updateCurrentJob = function (rpcData) {
        var tmpBlockTemplate = new blockTemplate(
            ...
            options.coin.percentTreasuryUpdateReward,
            options.coin.treasuryRewardUpdateStartBlockHeight,
            options.coin.treasuryRewardUpdateAddressChangeInterval,
            options.coin.vTreasuryRewardUpdateAddress,
