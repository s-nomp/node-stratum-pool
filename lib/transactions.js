...
exports.createGeneration = (blockHeight, blockReward, feeReward, recipients, poolAddress, poolHex, coin, masternodeReward, masternodePayee, masternodePayment) => {
    ...
    {
        tx.addOutput(new Buffer(rpcData.treasury.scriptPubKey, 'hex'), rpcData.treasury.amount); 
    }
    ...
    { 
        tx.addOutput(new Buffer(rpcData.masternode.script, 'hex'), rpcData.masternode.amount); 
    }
