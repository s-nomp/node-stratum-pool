...
var BlockTemplate = module.exports = function BlockTemplate(
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            ...
            let parameters = this.coin.parameters;

            if(parameters && parameters.N === 144 && parameters.K === 5 && parameters.personalization){
        		this.jobParams[8] = '144_5';
        		this.jobParams[9] = parameters.personalization;
            }
        }
