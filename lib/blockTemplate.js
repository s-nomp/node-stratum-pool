...
var BlockTemplate = module.exports = function BlockTemplate(
    ...
    if(coin.coinbasevaluesupport)
    {
        // Reward fees are included in coinbasevalue
        blockReward = {
            "total": rpcData.coinbasevalue
        };
        this.rewardFees = 0;
    }
        
    if(coin.rpcTreasury)
        blockReward.total -= rpcData.treasury.amount;
        
    if(coin.rpcMasternodeDashFormat)
        blockReward.total -= rpcData.masternode.amount;
